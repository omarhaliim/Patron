import '../send_contact_list_screen/widgets/listuser1_item_widget.dart';
import '../send_contact_list_screen/widgets/listuser_eight1_item_widget.dart';
import 'controller/send_contact_list_controller.dart';
import 'models/listuser1_item_model.dart';
import 'models/listuser_eight1_item_model.dart';
...
class SendContactListScreen extends GetWidget<SendContactListController> {
                                                      ...
                                                      child: Obx(() =>
                                                          ListView.builder(
                                                              ...
                                                              itemCount: controller
                                                                  .sendContactListModelObj
                                                                  .value
                                                                  .listuserEight1ItemList
                                                                  .length,
                                                              itemBuilder:
                                                                  (context,
                                                                      index) {
                                                                ListuserEight1ItemModel
                                                                    model =
                                                                    controller
                                                                        .sendContactListModelObj
                                                                        .value
                                                                        .listuserEight1ItemList[index];
                                                                return ListuserEight1ItemWidget(
                                                                    model,
                                                                    onTapContactBox:
                                                                        onTapContactBox);
                                                              })))
