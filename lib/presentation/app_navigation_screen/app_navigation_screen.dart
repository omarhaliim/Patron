...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  onTapSuccessfulRequest() {
    Get.toNamed(AppRoutes.successfulRequestScreen);
  }

  onTapSuccessfulSend() {
    Get.toNamed(AppRoutes.successfulSendScreen);
  }
  ...
  onTapSendConfirmation() {
    Get.toNamed(AppRoutes.sendConfirmationScreen);
  }

  onTapRequestcontactList() {
    Get.toNamed(AppRoutes.requestContactListScreen);
  }
  ...
  onTapRegistration3One() {
    Get.toNamed(AppRoutes.registration3OneScreen);
  }
  ...
  onTapCredit() {
    Get.toNamed(AppRoutes.creditScreen);
  }
